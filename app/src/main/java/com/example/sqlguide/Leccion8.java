...
public class Leccion8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leccion8);
    ...
    public void mostrar(View view){
        ...
        String validacion = "select * from friends_of_pickles where especie not in ('gato', 'perro');";
